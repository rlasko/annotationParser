# For praise files with time stamp and all mix-se and mix-sd files
...
run("/Users/RaeLasko/Documents/CMU/ArticuLab/TAR source files/mix-sd/converted/column_fix")
